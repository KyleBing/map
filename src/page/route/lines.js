...
const LINES = [
    ...
    },
    {
        ...
        paths: [
            ...
            {position: [117.213688,36.673087], name: '经十东路-末', note: ''},
            {position: [117.209116,36.673922], name: '邢村立交', note: ''},
            {position: [117.19562,36.67307], name: '融创茂', note: ''},
            {position: [117.146845,36.662953], name: '舜泰广场&汉峪金谷', note: ''},
            {position: [117.127391,36.660138], name: '浪潮', note: ''},
            {position: [117.120165,36.660012], name: '奥体中心', note: ''},
            {position: [117.100743,36.657516], name: '万象城', note: ''},
            {position: [117.096387,36.656259], name: '美术馆&博物馆', note: ''},
            {position: [117.096387,36.656259], name: '燕山立交', note: ''},
            {position: [117.041552,36.648587], name: '师范大学（千佛山）', note: ''},
            {position: [117.028892,36.648604], name: '山大（千佛山）', note: ''},
            {position: [117.02143,36.648599], name: '泉城公园', note: ''},
            {position: [117.010074,36.648612], name: '山东体育中心', note: ''},
            {position: [117.010074,36.648612], name: '八一立交', note: '建议走中间路，|走辅路还需要转两个弯'},
            {position: [117.010074,36.648612], name: '槐苑广场（北）', note: ''},
            {position: [116.963553,36.648868], name: '济南儿童医院（南）', note: ''},
